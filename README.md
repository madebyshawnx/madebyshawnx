...
My tech stack is a collection of products, labs, and learning artifacts I have personally designed, built, tested, and deployed across product management , AI, IT, the cloud and cybersecurity. Some are live and out in the wild, while others show how I explore ideas and solve problems. **Click around. Explore the work. See how I think, build, and ship.**
...
| SIEM implementation, log analysis, network traffic monitoring, and attack detection | pending |
| Security automation with Shuffle SOAR, incident response execution, case management with TheHive, and scripting for threat mitigation | pending |
