...
## Projects
### Cloud & Infrastructure
- [Launch Windows VM via RDP](https://github.com/YOUR_USERNAME/Labs/tree/main/001-aws-ec2-launch-windows-vm-rdp)
- [Configure Active Directory Domain Services](https://github.com/YOUR_USERNAME/Labs/tree/main/002-aws-ec2-configure-active-directory-adds)
- [Create AD Users, OUs & Groups](https://github.com/YOUR_USERNAME/Labs/tree/main/003-active-directory-create-users-ous-groups)
- [EC2 Lost Key Pair Recovery](https://github.com/YOUR_USERNAME/Labs/tree/main/004-aws-ec2-lost-key-pair-recovery)
- [Host a Static Website](https://github.com/YOUR_USERNAME/Labs/tree/main/007-how-to-host-a-static-website)

### Cybersecurity
- [Tenable Vulnerability Scans in Azure](https://github.com/YOUR_USERNAME/Labs/tree/main/008-setting-up-a-virtual-machine-and-running-tenable-vulnerability-scans-in-azure)
- [Tenable Vulnerability Scans on Linux VM](https://github.com/YOUR_USERNAME/Labs/tree/main/009-running-vulnerability-scans-on-a-Linux-virtual-machine)

### Automation & Scripting
- [Provision ServiceNow Tickets via PowerShell](https://github.com/YOUR_USERNAME/Labs/tree/main/005-servicenow-provision-tickets-powershell)
- [Provision AD Users via PowerShell](https://github.com/YOUR_USERNAME/Labs/tree/main/006-active-directory-provision-users-powershell)

### AI
*Coming soon — building projects in AI/ML and GenAI applications.*

### Product Management
*Coming soon — case studies and frameworks from enterprise product work.*
